...
import ReportHome from "./components/Reports/ReportsHome"
    ...
    <Router>
      <div className="App">  
        ...
        <Switch> 
          ...
          <ProtectedRoute path={URL_STUDENT_LIST_OF_DEPARTMENT} exact component={StudentListOfDepartment}/>
          ...
          <ProtectedRoute path={URL_INTERNSHIP_OFFER_FORM} exact component={InternshipOfferForm}/>

          <ProtectedRoute path={REPORT_LINK} exact component={ReportHome}/>
