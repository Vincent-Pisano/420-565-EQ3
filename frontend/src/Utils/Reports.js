...
import {
  ...
  TITLE_STUDENT_LIST_WAITING_INTERVIEW_RESPONSE,
  TITLE_STUDENT_LIST_WITH_INTERNSHIP,
  TITLE_STUDENT_LIST_WAITING_SUPERVISOR_EVALUATION,
  TITLE_STUDENT_LIST_WAITING_MONITOR_EVALUATION,
} from "./TITLE";
import {
  ...
  URL_STUDENT_LIST_WAITING_INTERVIEW_RESPONSE,
  URL_STUDENT_LIST_WITH_INTERNSHIP,
  URL_STUDENT_LIST_WAITING_SUPERVISOR_EVALUATION,
  URL_STUDENT_LIST_WAITING_MONITOR_EVALUATION,
} from "./URL";
...
let reports = [
  ...
  {
    id: "8",
    title: TITLE_STUDENT_LIST_WAITING_INTERVIEW_RESPONSE,
    link: URL_STUDENT_LIST_WAITING_INTERVIEW_RESPONSE,
    icon: faUserClock,
  },
  {
    id: "9",
  ...
  {
    id: "10",
    title: TITLE_STUDENT_LIST_WAITING_SUPERVISOR_EVALUATION,
    link: URL_STUDENT_LIST_WAITING_SUPERVISOR_EVALUATION,
    icon: faIdBadge,
  },
  {
    id: "11",
    title: TITLE_STUDENT_LIST_WAITING_MONITOR_EVALUATION,
    link: URL_STUDENT_LIST_WAITING_MONITOR_EVALUATION,
    icon: faIdBadge,
  },
];
